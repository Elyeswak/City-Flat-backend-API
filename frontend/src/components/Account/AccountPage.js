        ...
        <div className="card mb- color-white">
          <div className="card-body text-center">
            ...
            <div className="d-flex justify-content-center mb-2">
              <button type="button" className="btn btn-outline-primary ms-1 edit-profile">EDIT MY PROFILE</button>
            </div>
          </div>
        </div>
      </div>
      <div className="col-lg-8">
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="card mb-4 mb-md-0 color-white">
              <div className="card-body">
                <p className="mb-4">My reservations
                </p>
